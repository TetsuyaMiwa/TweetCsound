...
| No | Opcodes used | Description |	 Description(J) |	
| --- | --- | --- | --- |  
| 1 | schedule,schedkwhen,dust,expon,oscilimlinenr | Sound like UFO? : Sine wave whose pitch is modulated by LFO. The density of the events is controlled by 'dust'. | UFOのような音：LFOでピッチを上下させたサイン波のinstrを、dustで密度をコントロールしてscheduleする |  
